...
class BirdsDataset(utils.Dataset):
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("Black_footed_Albatross") != -1:
                print ("Black_footed_Albatross")
                labels_form.append("Black_footed_Albatross")
            elif labels[i].find("Laysan_Albatross") != -1:
                print ("Laysan_Albatross")
                labels_form.append("Laysan_Albatross")
